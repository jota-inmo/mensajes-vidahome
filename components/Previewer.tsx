            ...
            <div className="space-y-4 p-4 bg-slate-900 rounded-lg">
                ...
                {template.imageUrl && (
                    <div className="p-3 bg-yellow-900/50 border border-yellow-700 rounded-md text-yellow-300 text-sm">
                        <strong>Nota Importante:</strong> La imagen de arriba no se adjuntará automáticamente. Por favor, <strong>adjúntala manualmente en WhatsApp</strong> después de abrir el chat.
                    </div>
                )}
